 ...
 */
package com.sgaidai.jsf2elements;
...
@SessionScoped
public class UserBeancolor implements Serializable{
    boolean rememberMe;
    String[] favNumber1;
    String[] favNumber2;
    String[] favNumber3;
    ...
    public static void setNumber3Value(Map<String, Object> number3Value) {
        UserBeancolor.number3Value = number3Value;
    }
	...
	public String[] getFavNumber2Value() {
		...
		favNumber2[0] = "Number2 - A";
		favNumber2[1] = "Number2 - B";
		favNumber2[2] = "Number2 - C";
		favNumber2[3] = "Number2 - D";
		favNumber2[4] = "Number2 - E";
